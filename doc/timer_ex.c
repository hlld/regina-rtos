...
#define timer_period 500u
rt_timer_handle timer_hdl;

void timer_func(rt_pvoid parg) 
{
	rf_print("Regina timer is running\n");
}
...
int main(int argc, char* argv[])
{
	...
	rf_create_timer(timer_hdl, timer_period, timer_func, NULL);
